/******************************************************************************/
/*SERIAL.C                                                                    */
/*This file vas written by Dr. A Pomfret for the Systems Programming for      */
/*embedded devices module.                                                    */
/******************************************************************************/
#include "serial.h"
#include "stm32f4xx.h"
...
static void _configUSART2(uint32_t BAUD)
{
  ...
  USART2->CR1 |= USART_CR1_TE | USART_CR1_RE | USART_CR1_RXNEIE;	/* Enable Tx */
